...
def loading_and_prepareing_data_for_qgis(uid, attribute_table_csvfile_name, global_solar_irradiance_geometry_csvfile_location, global_solar_building_analysis_csvfile_location, globla_solar_daily_irradiance_analysis_csvfile_location):
    ...
    for julian_date in range(1, end_julian_date):
        ...
        for uid in attribute_table_csv_df['uid']:
            # Checking
            program_name = "Daily Solar Irradiance"
            checking_program_progress(uid, end_julian_date ,julian_date, program_name)
        ...
        global_date_table_df.columns = ['Date', 'JulianDate']
