...
def input_dedrived_data(attribute_table_csv, uid):
    ...
    #order_column = pd.Series({'uid':'uid', 'lat':'lat', 'long':'long', 'height':'height', 'Area': 'area', 'rooftype':'rooftype', 'rooftop':'rooftop'})
    ...
    fields_table_df = fields_table_df.reset_index(drop=True)
    #print(fields_table_df)
